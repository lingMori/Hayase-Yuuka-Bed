...
DOWNLOAD_CONFIG = {
    # image save path
    #   NOTE: DO NOT miss "/"
    "STORE_PATH": "E://vscode_clustter//code//github//Animate-Image-Bed//utils//crawler//test//images/",
